...
api_id = 22292563
api_hash = "b43b86997e4c919a5980bf7524d2256d"
# bot_token = "7120875823:AAEXsYIht8bi9UiuZw4ZeKnraZDSVtcJMV0"
bot_token ="6814299668:AAEWRqeuTmoMRSur4wiqe6yBIyW2Uhbxc7s"
...
async def welcome(client: Client, message: Message):
    for new_member in message.new_chat_members:
        ...
        await app.send_message(message.chat.id, f"<b>Ласкаво просимо!</b> \n\nВиберіть число <u><b>{captcha_num}</b></u> на кнопках нижче.\n\n", reply_markup=keyboard)
